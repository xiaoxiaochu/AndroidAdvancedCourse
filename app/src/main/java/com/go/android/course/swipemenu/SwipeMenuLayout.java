...
public class SwipeMenuLayout extends LinearLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.i("ontouch", "onTouch  Down" + mDownX + mDownY);
               // return true;
                break;
            case MotionEvent.ACTION_MOVE:
                int dx = (int) (mDownX - event.getX());
                int dy = (int) (mDownY - event.getY());
                Log.i("eventTouch", dx +"dx" + dy + "dy");
                //如果Y轴偏移量大于X轴偏移量 不再滑动
                ...
                Log.i("ontouch", "onTouch  move" );
                break;
            case MotionEvent.ACTION_UP:
                Log.i("ontouch", "onTouch  up");
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i("ontouch", "inIntercept Down");
                break;
            case MotionEvent.ACTION_MOVE:
                //必须要在MOVE中return才有效果，在这里return后UP事件也会被拦截
                Log.i("ontouch", "inIntercept move");
              //  return true;
            case MotionEvent.ACTION_UP:
                Log.i("ontouch", "inIntercept up");
            case MotionEvent.ACTION_CANCEL:
                Log.i("ontouch", "inIntercept cancel");
                break;
        }
      //  return true;
